    ...
    <section className="w-full bg-white px-4 py-20 font-poppins">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-2 text-lg md:text-xl font-semibold text-primary italic">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div className="mt-8 space-y-6 text-xl text-secondary">
              <p>
          ...
          <div className="space-y-6 text-lg text-secondary">
            <p>
            one box, we workshop your deal and send it to the people most
                likely to get you approved on the best terms.</p>
            <p>
